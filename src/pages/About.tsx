      ...
      <div className="container-max">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-8 rounded-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-center">
                  <MapPin className="text-primary-600 dark:text-primary-400 mr-3" size={20} />
                  <span className="text-gray-900 dark:text-gray-300">{personalInfo.location}</span>
                </li>
                <li className="flex items-center">
                  <GraduationCap className="text-primary-600 dark:text-primary-400 mr-3" size={20} />
                  <span className="text-gray-900 dark:text-gray-300">Computer Science Student</span>
                </li>
                <li className="flex items-center">
                  <Briefcase className="text-primary-600 dark:text-primary-400 mr-3" size={20} />
                  <span className="text-gray-900 dark:text-gray-300">Software Developer & Researcher</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            {education.map((edu) => (
              <div key={edu.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <div className="text-right">
                    <p className="text-gray-600 dark:text-gray-400 flex items-center justify-end">
                      <Calendar size={16} className="mr-1" />
                      {edu.startDate} - {edu.endDate || 'Present'}
                    </p>
                    {edu.gpa && (
                      <p className="text-gray-700 dark:text-gray-300 font-medium">GPA: {edu.gpa}</p>
                    )}
                  </div>
                </div>
                {edu.relevantCourses && (
        ...
        <section>
          ...
          <div className="space-y-6">
            {experience.map((exp) => (
              <div key={exp.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
